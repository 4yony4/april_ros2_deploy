...
git clone --branch galactic git@github.com:aprilprojecteu/april_vision_msgs.git vision_msgs
...
git clone --branch main git@github.com:aprilprojecteu/yarp_msgs_ros1.git yarp
...
git clone git@github.com:aprilprojecteu/yarp_ros_talker.git
