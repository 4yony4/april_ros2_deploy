...
gnome-terminal --title="BUILDING ROS2 APRIL_MSGS" --tab -- bash -c "current_path="$PWD"; path_to_one="$PWD"/1; project_path=${current_path}/..; cd $current_path; source ros2_init.sh; cd $path_to_one; source april_msgs_ws_ROS2_build.sh; exec bash -i"
